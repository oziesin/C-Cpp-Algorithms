...
typedef int32_t (*ST25DV_GetTick_Func) (void);
...
#define ST25DV_ADDR_USER_MEM_WRITE_I2C                0xA6
#define ST25DV_ADDR_DYN_REG_WRITE_I2C                 0xA6
#define ST25DV_ADDR_FTM_WRITE_I2C           		      0xA6

#define ST25DV_ADDR_USER_MEM_READ_I2C                 0xA7
#define ST25DV_ADDR_DYN_REG_READ_I2C                  0xA7
#define ST25DV_ADDR_FTM_READ_I2C           		      	0xA7
/** @brief I2C address to be used for ST25DV System accesses. */
#define ST25DV_ADDR_SYST_I2C                 		0xAE
#define ST25DV_ADDR_SYST_WRITE_I2C                 		0xAE
#define ST25DV_ADDR_SYST_READ_I2C                  		0xAF
